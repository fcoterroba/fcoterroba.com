---
title: "proyecto Python medio: ¿cómo crear una API usando FastAPI?"
description: "tutorial práctico para crear una API completa con Python y FastAPI, desde la instalación hasta la documentación automática."
excerpt: "aprende a crear una API REST completa con Python y FastAPI paso a paso, incluyendo endpoints, datos JSON y documentación automática."
...
- Una API (abreviatura de **A**pplication **P**rogramming **I**nterfaces), es, básicamente, un conjunto de definiciones y protocolos que se utilizan para desarrollar e integrar el software de las aplicaciones o webs. Permitiendo así la comunicación entre dos aplicaciones a priori totalmente distintas.
...
- Por lo general, una API devuelve la información cuando es requerida en formato JSON y es el desarrollador en su nueva web o software, el encargado de hacer legible dicha información.
  - Por ejemplo, esta API gratuita de [Los Simpsons](https://thesimpsonsquoteapi.glitch.me/), si accedes a la API básica, te devuelve una frase de alguno de los personajes de esta serie.
...
- Ofrece una legibilidad bastante buena y cercana a la lectura humana.
  - En la categoría [Python](https://fcoterroba.com/category/python) de la web puedes encontrar +8 proyectos con Python divididos por su dificultad. ¿A qué esperas? Tu API puede esperar.
...
![Comparación de rendimiento](/blog/python-fastapi/comparacion-rendimiento.png)
...
## 3️⃣ TERCER PASO 3️⃣ Más funciones y páginas
...
## 4️⃣ CUARTO PASO 4️⃣ Página principal
...
![Página principal de la API](/blog/python-fastapi/imagen-4.png)

## 5️⃣ QUINTO PASO 5️⃣ Generar documentación
...
![Documentación automática](/blog/python-fastapi/documentacion.png)
